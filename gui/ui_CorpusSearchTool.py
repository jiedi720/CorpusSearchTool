...
class Ui_CorpusSearchTool(object):
    def setupUi(self, CorpusSearchTool):
        ...
        CorpusSearchTool.resize(700, 800)
        CorpusSearchTool.setMinimumSize(QSize(700, 800))
        CorpusSearchTool.setMaximumSize(QSize(800, 800))
...
"}")
        ...
        self.corpus_tab_widget.setMaximumSize(QSize(999, 200))
...
"}")
        ...
        self.verticalLayout_3 = QVBoxLayout(self.english_tab)
...
"}")
        ...
        self.english_keyword_edit.setMinimumSize(QSize(150, 30))
        self.english_keyword_edit.setMaximumSize(QSize(16777215, 30))
...
"}")
        ...
        self.horizontalLayout_7.addWidget(self.english_lemma_display)
        ...
        self.horizontalLayout_8.addWidget(self.english_lemmalist_label, 0, Qt.AlignmentFlag.AlignTop)
...
"}")
        ...
        self.verticalLayout_5 = QVBoxLayout(self.korean_tab)
...
"}")
        ...
        self.korean_keyword_edit.setMinimumSize(QSize(150, 30))
        self.korean_keyword_edit.setMaximumSize(QSize(16777215, 30))
...
"}")
        ...
        self.horizontalLayout_4.addWidget(self.korean_lemma_display)
...
"}")
        ...
        self.verticalLayout_2.addWidget(self.english_regex_check)

        self.english_fuzzy_match_check = QCheckBox(self.centralwidget)
        self.english_fuzzy_match_check.setObjectName(u"english_fuzzy_match_check")
        self.english_fuzzy_match_check.setFont(font)

        self.verticalLayout_2.addWidget(self.english_fuzzy_match_check)
        ...
        self.verticalLayout_2.addWidget(self.english_case_sensitive_check)
        ...
        self.history_btn.setMaximumSize(QSize(150, 50))
...
"")
        icon3 = QIcon()
        icon3.addFile(u"../icons/history.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.history_btn.setIcon(icon3)
        self.history_btn.setIconSize(QSize(28, 28))

        self.gridLayout.addWidget(self.history_btn, 0, 0, 1, 1)

        self.search_btn = QPushButton(self.centralwidget)
        self.search_btn.setObjectName(u"search_btn")
        self.search_btn.setMinimumSize(QSize(81, 30))
...
"}")
        ...
        self.gridLayout.addWidget(self.search_btn, 1, 0, 1, 1)
...
"}")
    ...
    def retranslateUi(self, CorpusSearchTool):
        ...
        self.english_lemma_display.setText(QCoreApplication.translate("CorpusSearchTool", u"N/A", None))
